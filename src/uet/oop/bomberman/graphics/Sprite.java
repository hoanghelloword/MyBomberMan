 ...
 * (đối tượng riêng: vd nhân vật)
 */
public class Sprite {
    /** kích thước của sprite ( dài = rộng)*/
    public final int SIZE;
    /**
    tọa độ trong sprite sheet
    gói mảng 2 chiều vào mảng 1 chiều
    tọa độ trong mảng 2 chiều là x , y
    thì trong mảng 1 chiều là x + y*SIZE */
    private int _x, _y;
    /** mảng sprite sheet ,lưu dữ liệu màu của Sprite */
    public int[] _pixels;
    /**chiều dài rộng thực tế*/
    protected int _realWidth;
    protected int _realHeight;
    private SpriteSheet _sheet;
    /**sheet1 lưu các đối tượng ko thay đổi trong map*/
	 ...
	 */
    /**
     * grass, wall, portal lấy hình aảnh từ file tile.png được lưu trong spritesheet1
     */
    ...
    /**set màu cho tất cả các pixel của ảnh */
    ...
    /**
     * file word
     * Lấy tất cả pixel của ảnh nhỏ từ ảnh lớn
     */
    private void load() {
